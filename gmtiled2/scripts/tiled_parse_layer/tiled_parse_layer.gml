...
ds_map_add(layer_map, "width", real(DerpXmlRead_CurGetAttribute("width")));
ds_map_add(layer_map, "height", real(DerpXmlRead_CurGetAttribute("height")));
ds_map_add(layer_map, "offsetx", DerpXmlRead_CurGetAttribute("offsetx"));
ds_map_add(layer_map, "offsety", DerpXmlRead_CurGetAttribute("offsety"));
